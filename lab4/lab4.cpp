...
double sigma(double* y, double* COEF, int N, int m, double* x, double SIGMA)
{
...
int main()
{
	...
	cout << "Right side of the system: " << endl;
	...
	SIGMA = sigma(p, COEF, N, m, H, SIGMA);
	...
	cout << "Koeff: " << newCOEF[0] << "; " << newCOEF[1] << endl << endl;
